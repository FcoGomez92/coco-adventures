...
contract codex {
    ...
    // Igual que codex-items-armor pero con otros niveles de proficiency
    ...
    // devuelve el encumbrance en funcion de un id
    ...
    // devuelve el tipo de daño en funcion de un id
    ...
    // se crea el objeto tipo "weapon" y se definen sus caracteristicas / propiedades
    struct weapon {
        uint256 id;
        uint256 cost;
        uint256 proficiency;
    ...
    // devuelve un item en funcion de una id
    ...
    //  a partir de aqui se crean las distintas armas
