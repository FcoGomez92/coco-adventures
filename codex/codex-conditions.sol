...
contract codex {
    string public constant index = "Condition";
    string public constant class = "Any";

    // devuelve el nombre de la ventaja en base a una id
    ...
    // devuelve todos los datos de una condicion según su id
    ...
    // devuelve el nombre de un atributo en base a una id
    ...
    // a partir de aquí se configuran las distintas condiciones:
    function normal()
        public
        pure
        returns (
